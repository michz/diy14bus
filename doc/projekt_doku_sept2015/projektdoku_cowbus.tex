...
\begin{abstract}
Auf einem \emph{STM32F0}-Microcontroller soll mit Hilfe des Funkchips
\emph{nrf24l01+} und des Betriebssystems RIOT OS ein offener Bus für die
...
\section{Einleitung}
    ...
    Diese Arbeit versucht eine Plattform zu schaffen, die günstig nachbaubar ist.
    Sie soll für Bastler, Macher, Studenten, Forscher und weitere Interessierte
    niedrige Einstiegshürden in den Bereich der drahtlosen Sensornetze bieten.

\section{Motivaton}
    \TODO{Gateways raus, prägnanter}
...
\section{???}
    \TODO{sinnvoll ordnen, Überschrift, etc.}
    \subsection{Funkchip \emph{nrf24l01+}}
    \TODO{neutraler, weniger Erzählstil}
...
Diese werden im weiteren Verlauf beschrieben.
    ...
    \subsection{Paketaufbau}
        ...
        \TODO{allgemein: Paketstruktur auf PHY-Schicht von eigener Paketstruktur auf MAC-Schicht unterscheiden}
...
\section{Ausblick}
    ...
    \subsection{Verschlüsselung}
        \TODO{in Sicherheit umbenennen und knackiger/aussagekräftiger machen}
