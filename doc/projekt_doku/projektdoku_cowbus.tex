...
\todo{rausnehmen oder was schreiben}
...
\section{Systemaufbau}
    ...
    \subsection{Paketaufbau}
        ...
        Abbildung \label{fig:paket} zeigt den Aufbau der Pakete. Die Pakete 
        bestehen aus:
        \begin{itemize}
...
\section{Ausblick}
    ...
    keiner Weise koordiniert. Sobald ein Knoten Daten zum versckicken hat, 
    ...
    Carrier Sensing (dt. Trägerpfüfung). Dies bedeutet, dass ein sender lauscht, 
    ob der Kanal frei sit, bevor er sendet. Der Sender wartet, falls ein zweiter 
    ...
    den minimalen zeitlichen Abstand zwischen zwei esendeten Datenrahmen auf 
