...
\begin{frame}
    \frametitle{Ziele und Ideen}
		    ...
		    \begin{itemize} \setlength{\itemsep}{\customitemsep}
		        \uncover<1->{\item dezentrale Organisation}
		        \uncover<2->{\item komfortable Konfiguration, nicht jeden Knoten \enquote{anfassen} müssen
		        ...
		        \uncover<3->{\item einfach nachvollziehbare Schaltregeln}
		        \uncover<4->{\item typische Anforderungen an Energieversorgung beachten
		            \begin{itemize} \setlength{\itemsep}{\customitemsepsub}
...
\begin{frame}
    \frametitle{Demo}
		\begin{columns}        
        	...
        	\uncover<3->{\includegraphics[width=.9\linewidth]{img/img-pi-rf.jpg}}
			\column{.6\textwidth}
		        \uncover<1->{
		       	Sensor:
        		\begin{itemize} \setlength{\itemsep}{\customitemsep}
		            \item cowbus-protoboard mit RIOT und einfacher Anwendung %TODO will man da RIOT zitieren?
