...
\section{Projektverlauf und Meilensteine}
    ...
    gegeben, \enquote{RIOT OS} anzuschauen. \url{http://www.riot-os.org/} 
...
Es war der günstigste, der den Anforderungen von Riot und denen des entworfenen Protokolls genügt.
...
Trotz der großen Startschwierigkeiten mit dem verwendeten Betriebssystem, würde auch beim nächsten Projekt die Wahl erneut auf Riot fallen. Anpassungen an der Hardware Abstraction Layer (HAL) und Integration von Treibern sind einmalige Anwendungsunabhängige Angelegenheiten. Riot ist noch lange nicht fertig entwickelt und gerade das laufende Refactoring im Netzwerkstack weckt viel versprechende Erwartungen für die Zukunft des Betriebssystems.
