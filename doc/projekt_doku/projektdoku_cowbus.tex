...
\section{Projektablauf und Meilensteine}
    ...
    \subsection{Erstes Brainstorming und Projektplanung}
        ...
        Projektverlauf mehr über Technologie und Funktionsumfang festlegen, wollen wir 
        einen "richtigen" Namen wählen. Die Wahl viel dann auf cowbus.

        TODO: Festlegung konkreter Ziele.

        TODO: Projektplanung 
        /*
        Oktober: Kennenlernen, Wissensaustausch und Einarbeitung in 
...
\section{Systemaufbau}
    ...
    - Hardware bedingt sind wir für die übertragenen Pakete auf 32 Byte beschränkt, dazu in der späteren Beschreibung über den Funkchip mehr. 

    *Zum Sendepaket male ich nachher noch ein Bild

    - 5 Bit Sequenznummer: aufsteigent, für jeden Teilnehmer individuell
    - 8-Bit Time To Live: Maximalwert, der beim Weiterleiten decrementiert wird
    - 11-Bit Adresse: Kontexabhängig ob stc/dst
    - 4-Bit Type (TODO)
    - 1-Bit "is frag": ist das ein aufgeteiltes Paket? -> Fragment Header am Anfang vom Payload
    - 208-Bit Payload
    -> macht 26 Byte
    - 16-Bit CRC
